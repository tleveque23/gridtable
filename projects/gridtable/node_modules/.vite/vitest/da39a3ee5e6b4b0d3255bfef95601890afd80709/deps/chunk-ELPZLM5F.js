import {
  ...
  ɵɵdefineInjectable
} from "./chunk-A6K4WFYP.js";
import {
  ResourceLoader
} from "./chunk-TUSII7GS.js";
import {
  Subscription
} from "./chunk-R4EGQH6B.js";
...
var RETHROW_APPLICATION_ERRORS_DEFAULT = true;
var TestBedApplicationErrorHandler = class _TestBedApplicationErrorHandler {
  zone = inject(NgZone);
...
var DeferBlockFixture = class _DeferBlockFixture {
  block;
  componentFixture;
...
var THROW_ON_UNKNOWN_ELEMENTS_DEFAULT = false;
var THROW_ON_UNKNOWN_PROPERTIES_DEFAULT = false;
var DEFER_BLOCK_DEFAULT_BEHAVIOR = DeferBlockBehavior.Playthrough;
var ANIMATIONS_ENABLED_DEFAULT = false;
...
var ComponentFixture = class {
  ...
  _renderer;
  _isDestroyed = false;
  _noZoneOptionIsSet = inject(ComponentFixtureNoNgZone, {
    optional: true
  });
  ...
  autoDetect = inject(ComponentFixtureAutoDetect, {
    optional: true
...
var TestBedImpl = class _TestBedImpl {
  ...
  createComponent(type, options) {
    ...
    testComponentRenderer.insertRootElement(rootElId, shouldInferTagName ? inferTagNameFromDefinition(componentDef) : void 0);
...
var TestBed = TestBedImpl;
function inject2(tokens, fn) {
  const testBed = TestBedImpl.INSTANCE;
  return function() {
    return testBed.execute(tokens, fn, this);
  };
}
var InjectSetupWrapper = class {
  _moduleDef;
  ...
  inject(tokens, fn) {
    ...
    return function() {
      self._addModule();
      return inject2(tokens, fn).call(this);
    };
  }
};
...
var FakeNavigationHistoryEntry = class {
  eventTarget;
  url;
  sameDocument;
  id;
...
var FakeNavigationDestination = class {
  url;
  sameDocument;
  key;
  id;
...
var InternalNavigationTransition = class {
  from;
  to;
  navigationType;
  finished;
...
var InternalNavigationResult = class {
  navigation;
  committedTo = null;
  committedResolve;
  committedReject;
...
//# sourceMappingURL=chunk-ELPZLM5F.js.map
