...
## Core Features
- **Advanced Column Sizing**: The primary motivation for this component. Complete control over minimum, maximum, and default column widths. The table width naturally conforms to its content by default, overcoming the stretching limitations of standard HTML tables through CSS Grid.
