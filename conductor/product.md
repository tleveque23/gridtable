...
## Core Features
- **Advanced Column Sizing**: The primary motivation for this component. Complete control over minimum, maximum, and default column widths, as well as the overall table width, overcoming the limitations of standard HTML tables through CSS Grid.
